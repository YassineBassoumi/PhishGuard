...
Analyse ciblée des emails sélectionnés pour une protection efficace des comptes personnels et professionnels.            </p>
          ...
          <div className="integration-card">
            <div className="integration-icon-wrapper yahoo-icon">
              <svg width="64" height="64" viewBox="0 0 24 24" fill="none">
                <circle cx="12" cy="12" r="10" fill="#6001D2"/>
                <text x="12" y="16" textAnchor="middle" fill="white" fontSize="12" fontWeight="bold">Y!</text>
              </svg>
            </div>
            <h3 className="integration-name">Yahoo Mail</h3>
            <p className="integration-description">
Sécurisez votre boîte Yahoo en analysant les emails sélectionnés grâce à notre technologie de détection avancée.            </p>
            <div className="integration-users">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/>
                <circle cx="9" cy="7" r="4"/>
